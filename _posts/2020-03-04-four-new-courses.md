...
<table>
    <tbody>
        ...
        <tr>
            <td><a href="{% link _courses/form.md %}">The Form(s) of Buddhism</a></td>
        ...
        <tr>
            <td><a href="{% link _courses/function.md %}">The Function of Buddhism</a></td>
...
<br>
As always, you can find the courses&nbsp;<a href="https://drive.google.com/drive/folders/1RJi6bEXa25zizGdsm5evCycYuY6a2D8r">on Google Drive</a> or <a href="{% link courses.md %}">right here</a>.<br>
<br>
Happy Studying!<br>
Than Khemarato
