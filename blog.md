...
The University is still a work in progress.[^drive] As it continues to expand, the University's monthly Newsletter marks the arrival of new [courses]({% link courses.md %}) and the best new [content]({% link library.md %}).[^changes] To hear about the latest, subscribe to one of our [atom (rss) feeds](/feed) or sign up for our [emails](https://tinyletter.com/buddhist-uni){:target="_blank" ga-event-value="0.4"}:
