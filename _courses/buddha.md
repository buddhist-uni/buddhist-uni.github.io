...
If you're looking for a quick and inspiring biography of the Buddha, I recommend [*The Biography of Shakyamuni Buddha* by Master Hsing Yun](/content/monographs/biography-of-shakyamuni_hsing-yun). This course goes beyond the basics to reading the primary sources themselves, and therefore requires some comfort reading [the Early Buddhist Texts](/courses/ebts).
...
1. {% capture foo %}{% include inline_content.html category="articles" slug="wife-and-son_gindin-matthew" %}{% endcapture %}{{ foo | strip_newlines }}
