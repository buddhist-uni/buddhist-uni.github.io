...
lecturers:
  - analayo
icon: "fas fa-spinner"
description: "A course on part of the Madhyama Āgama held in 2013, the sutras covered (MA 72-86) all revolve around the interdependence of _samatha_ and _vipassana_ meditation and their co-creation of wisdom.  Bhikkhu Anālayo makes the difficult subject accessible in his inimitably methodical style."
time: 1
next_courses:
  - mn
  - samadhi
...
This course assumes a familiarity with [meditation]({% link _tags/meditation.md %}) and [the Pāli Canon]({% link _courses/ebts.md %}). Prior familiarity with [the Āgamas]({% link _tags/agama.md %}) is not required.
