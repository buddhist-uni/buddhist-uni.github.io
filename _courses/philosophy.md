...
<p> {% include inline_content.html category="av" slug="as-it-is_bodhi" %} </p>
...
{% include inline_content.html category="av" slug="early-buddhism_wisdom_sujato-and-brahmali" %}
...
{% include inline_content.html category="canon" slug="mn26" %}
...
{% include inline_content.html category="articles" slug="cosmology-and-meditation_gethin" %}
- Rupert Gethin gives us a way of reading Buddhist mythology as a guide to the terrain of meditation.

{% include inline_content.html category="articles" slug="normative-function-of-metatheory_stein-zak" %}
...
[BB-001_The_Buddha.mp3](https://drive.google.com/file/d/1vf43WM6V6DDSZLB_JUV9773XW5QyC0wU/view?usp=drivesdk){:target="_blank" ga-event-value="0.4"} - Bhikkhu Bodhi introduces us to the cosmology of Buddhism and the wonderous appearance of a Buddha in the world.
...
{% include inline_content.html category="av" slug="mn12-explanation_brahm" %}
...
{% include inline_content.html category="articles" slug="right-view-and-the-four-noble-truths_analayo" %}
- Venerable Analayo shows how the Four Noble Truths are akin to a medical treatment plan: from diagnosis to cure.

{% include inline_content.html category="canon" slug="mn141" %}
- The Venerable Sariputta gives a detailed analysis of the Four Noble Truths.

{% include inline_content.html category="booklets" slug="the-four-noble-truths_sumedho" %}
...
[BB-002_Four_Noble_Truths.mp3](https://drive.google.com/file/d/1-BJNwJOJHbYD2Dx--0E4RFpyuWYJO-KW/view?usp=drivesdk){:target="_blank" ga-event-value="0.3"} - Bhikkhu Bodhi gives a thorough treatment of suffering and introduces us to the five aggregates.
...
{% include inline_content.html category="canon" slug="sn35.85" %}
...
{% include inline_content.html category="canon" slug="sn22.59" %}
...
{% include inline_content.html category="essays" slug="am-i-my-khandas_cintita" %}
...
{% include inline_content.html category="canon" slug="sn5.10" %}
- The Bhikkhuni Vajira sums up the above in this beautiful poem.


{% include inline_content.html category="canon" slug="mn109" %}
...
{% include inline_content.html category="articles" slug="anicca_sharma-arvind" %}
- This essay gives an introduction to the three characteristics and, by analysis, their function.

{% include inline_content.html category="av" slug="anything-you-synthesize_american-dollar" %}
...
[BB-003_Nature_of_Existence.mp3](https://drive.google.com/file/d/17mDxe2bIwRNymm5XIsCihNPwz6v_LBV8/view?usp=drivesdk){:target="_blank" ga-event-value="0.2"} - Bhikkhu Bodhi gives a detailed analysis of the five aggregates and three characteristics.
...
{% include inline_content.html category="canon" slug="mn140" %}
...
{% include inline_content.html category="canon" slug="mn38" %}
...
{% include inline_content.html category="monographs" slug="heart-of-understanding_tnh" %}
...
[BB-004_Dependent_Origination.mp3](https://drive.google.com/file/d/1MI7Yvqg5F-u9asjhrA4BM76LhGiqAocm/view?usp=drivesdk){:target="_blank" ga-event-value="0.3"} - Bhikkhu Bodhi teaches the traditional analysis of Dependent Arising. 
...
{% include inline_content.html category="canon" slug="mn148" %}
...
{% include inline_content.html category="av" slug="mn148-explanation_nissarano" %}
...
{% include inline_content.html category="articles" slug="rebirth-and-the-west_analayo" %}
- On belief in rebirth and the Buddhist path in historical perspective.

{% include inline_content.html category="canon" slug="mn135" %}
- The Buddha explains how kamma accounts for the fortune and misfortune of beings.

{% include inline_content.html category="av" slug="teaching-karma_courtin-robina" %}
- Courtin describes how she introduces Karma to sceptical Westerners.

{% include inline_content.html category="essays" slug="paticca-samuppada_brahm" %}
...
{% include inline_content.html category="canon" slug="an5.57" %}
- The five subjects for frequent recollection

{% include inline_content.html category="essays" slug="interview-with-dr-tucker" %}
- Dr Jim Tucker is currently the world’s foremost scientist studying spontaneous past life recall.

#### Lecture

[BB-005_Rebirth_and_Karma.mp3](https://drive.google.com/file/d/1SP_qNBg8pnLkVs69J9pMfS2kLoaFwttm/view?usp=drivesdk){:target="_blank" ga-event-value="0.3"} - Bhikkhu Bodhi gives a detailed explanation of rebirth and kamma according to the Theravada Abhidhamma.
...
{% include inline_content.html category="canon" slug="mn42" %}
...
{% include inline_content.html category="articles" slug="sixfold-purity-of-an-arahant_analayo" %}
- A thorough description of what makes someone fully enlightened.

{% include inline_content.html category="canon" slug="an3.47" %}
- A short, enigmatic description of conditioned phenomena (saṃsāra) and unconditioned phenomena (nibbāna).

{% include inline_content.html category="canon" slug="ud8.3" %}
- A short exclamation on the existence of Nibbāna. 

{% include inline_content.html category="essays" slug="what-is-the-eye_cintita" %}
...
[BB-006_Nibbana.mp3](https://drive.google.com/file/d/1XXNh11FJSZcPVBSX-H9eP586u86E3EoD/view?usp=drivesdk){:target="_blank" ga-event-value="0.3"} - Bhikkhu Bodhi discusses the philosophical implications of the doctrine of Nibbāna drawn out in the Theravada Abhidhamma

#### Sutta Spotlight

{% include inline_content.html category="canon" slug="mn11" %}
...
{% include inline_content.html category="av" slug="mn11-explanation_suddhaso" %}
...
{% include inline_content.html category="booklets" slug="inspiring-dhamma_suchart" %}
...
[BB-007_Eightfold_Path.mp3](https://drive.google.com/file/d/1fvQuvAiXNoLH3wFzMQJkZd-cyZC3Eut9/view?usp=drivesdk){:target="_blank" ga-event-value="0.2"} - Bhikkhu Bodhi explains the middle way, from its mundane form to the supramundane version which delivers the yogi to nibbāna.

#### Sutta Spotlight

{% include inline_content.html category="canon" slug="mn75" %}
...
{% include inline_content.html category="av" slug="five-things-for-right-view_yuttadhammo" %}
...
{% include inline_content.html category="canon" slug="mn43" %}
...
{% include inline_content.html category="av" slug="fgbmr-address-2014_hsin-bao" %}
...
{% include inline_content.html category="booklets" slug="wisdom-develops-samadhi_mahabua" %}
- The modern, Thai meditation master Luang Ta Maha Boowa explains the path and purpose of meditation.

#### Lecture

[BB-008_Meditation.mp3](https://drive.google.com/file/d/10c36EY-72BEV8xvaYsv7jiCRoQEX3xt7/view?usp=drivesdk){:target="_blank" ga-event-value="0.3"} - Bhikkhu Bodhi explains the theory surrounding meditation practice.


#### Sutta Spotlight

{% include inline_content.html category="canon" slug="mn117" %}
...
{% include inline_content.html category="av" slug="mn117-explanation_brahmali" %}
...
{% include inline_content.html category="av" slug="mn13-explanation_brahm" %}
...
{% include inline_content.html category="articles" slug="this-is-peaceful-this-is-excellent_marajina" %}
...
[BB-010_The_Sangha.mp3](https://drive.google.com/file/d/1M_WCHHB3guPNAwF_sem_PKpHL4bSCzvM/view?usp=drivesdk){:target="_blank" ga-event-value="0.2"} - The Bhikkhu versus the Ariya Sangha and why it matters.
...
{% include inline_content.html category="canon" slug="mn137" %}
- The Buddha expounds the six internal and external sense bases and some related topics.

{% include inline_content.html category="av" slug="mn137-explanation_vayama" %}
...
{% include inline_content.html category="canon" slug="mn22" %}
