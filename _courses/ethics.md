...
image_width: 736
banner_info: <a href="https://commons.wikimedia.org/wiki/File:Vestnik_1946.jpg">Nicholas Roerich</a>
...
next_course_descs:
  ...
  - "Take your practice of ethics to the next level: the mind."
  - "A whole course of good advice and encouragement on persevering in our practice even when the going gets tough."
  - "Learn more about Buddhist Ethics as it relates to household life."
  - "A course for monastics and lay alike, learn more about the traditional practice of renunciation."
  - "An introduction to the northern schools of Buddhism, including a lot more information about this Bodhisattva thing."
---
...
{% include content_blurb.html category="essays" slug="five-precepts_vajirananavarorasa" %}
...
{% include content_box.html category="articles" slug="cultivation-of-virtue_fink-charles" %}
...
{% include content_blurb.html category="canon" slug="mn96" %}
- In which the Buddha thoroughly rejects the ancient Indian caste system. 

{% include content_blurb.html category="essays" slug="iyothee-tass_dhammika" %}
...
{% include content_blurb.html category="articles" slug="being-different-with-dignity_cheng-fung-kei" %}
...
{% include content_box.html category="av" slug="origins-of-buddhism_brahm" %}
