...
include_pattern = r"(https?://(?!.*archive\.org)\S*?(\.html?|\.mp3|pdf)|https?://\S*?/download\S*|https?://(www\.)?accesstoinsight\.org|https?://(www\.)?dhammatalks\.org|https?://(www\.)?thezensite\.com)"
