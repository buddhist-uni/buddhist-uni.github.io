...
def query_cache(sql: str, variables: tuple=tuple()) -> list[dict]:
  return gdrive.gcache.sql_query(
...
@backup_level(112, "GDocs", "All Google Docs, including the autogenerated ones")
...
def run_backup_level(level: BackupLevel, parallelism=8):
